...
contract Api3Paymaster is IPaymaster, Ownable {

    address public allowedToken;
    address public ERC20dAPIProxy;
    address public NATIVEdAPIProxy;
    ...
    function setDapiProxy(address _ERC20proxy, address _NATIVEproxy)
    public onlyOwner {
        ERC20dAPIProxy = _ERC20proxy;
        NATIVEdAPIProxy = _NATIVEproxy;
    }
    ...
    function validateAndPayForPaymasterTransaction (
        ...
        if (paymasterInputSelector == IPaymasterFlow.approvalBased.selector) {
            ...
            uint256 ETHUSDCPrice = readDapi(NATIVEdAPIProxy);
            uint256 USDCUSDPrice = readDapi(ERC20dAPIProxy);
